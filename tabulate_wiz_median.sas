...
%macro tabulate_wiz_median(in_lib = work, out_lib = work, in_table=, out_table=, class_list_row=, class_list_col=,N_VAR_LIST=, MEAN_VAR_LIST=,
        ...
        %IF %EVAL(%LENGTH(&class_list_col)>0) %THEN %DO;
             ...
             /********* THE MAIN TABULATE ***********/
             /**************************************/
             proc tabulate data = &in_lib..&in_table missing QMETHOD = P2 QNTLDEF = 5 out = &out_option;
